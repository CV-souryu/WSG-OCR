...
def main() -> None:
    ...
    cases = {
        ...
        # Goal 14 typical-problem battery at small UI sizes.
        "frag_ba_yu_32.png": ("鲃鱼", 32, (255, 255, 255), (0, 0, 0), 0.0),
        "frag_ba_yu_14.png": ("鲃鱼", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "frag_xiao_14.png": ("小", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "qianjia_14.png": ("潜甲", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "qianyi_14.png": ("潜乙", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "z17_14.png": ("Z17", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "baltimore_14.png": ("巴尔的摩", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "mixed_16.png": ("舰船Lv.99", 16, (255, 255, 255), (0, 0, 0), 0.0),
        "digits_16.png": ("1234567890", 16, (255, 255, 255), (0, 0, 0), 0.0),
        "short_word_14.png": ("使用", 14, (255, 255, 255), (0, 0, 0), 0.0),
        "long_word_16.png": (
            "塞瓦斯托波尔",
            16,
            (255, 255, 255),
